...
GET_FAKER_FUNCTION_QUESTION_TEMPLATE = "Generate Python code to create a JSON object with the following structure: {structure} using realistic data generated by 'faker' and 'random'. Only provide the dictionary content without any comments."
